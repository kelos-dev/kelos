...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GitHubPluginSource) DeepCopyInto(out *GitHubPluginSource) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GitHubPluginSource.
func (in *GitHubPluginSource) DeepCopy() *GitHubPluginSource {
	if in == nil {
		return nil
	}
	out := new(GitHubPluginSource)
	in.DeepCopyInto(out)
	return out
}

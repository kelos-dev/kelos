...
| `spec.when.slack.allowedBotIDs` | Allow specific Slack bot authors to trigger this TaskSpawner (bot IDs like `"B0123456789"`); when empty, bot-authored messages are ignored | No |

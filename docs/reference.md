...
provider conversation. In an interactive terminal, the client shows live
connecting, reconnecting, working, waiting-for-input, and interrupting status
with elapsed time. Press `Esc` while a turn is active to interrupt it.

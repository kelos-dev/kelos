...
# TaskPipeline, TaskRecord) are left as-is since no conversion is needed. controller-gen does
...
# TaskPipeline, TaskRecord) correctly skip conversion. The CA annotation is injected into an

...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha2.SchemeGroupVersion.WithResource("sessions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().Sessions().Informer()}, nil
	case v1alpha2.SchemeGroupVersion.WithResource("sessionspawners"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().SessionSpawners().Informer()}, nil
	...
	case v1alpha2.SchemeGroupVersion.WithResource("taskbudgets"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().TaskBudgets().Informer()}, nil
	case v1alpha2.SchemeGroupVersion.WithResource("taskpipelines"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().TaskPipelines().Informer()}, nil
	case v1alpha2.SchemeGroupVersion.WithResource("taskrecords"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().TaskRecords().Informer()}, nil
	case v1alpha2.SchemeGroupVersion.WithResource("taskrouters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().TaskRouters().Informer()}, nil
	...
	case v1alpha2.SchemeGroupVersion.WithResource("webhookgateways"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().WebhookGateways().Informer()}, nil
	case v1alpha2.SchemeGroupVersion.WithResource("workerpools"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Api().V1alpha2().WorkerPools().Informer()}, nil

...
type AgentConfigLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1alpha1.AgentConfig, err error)
...
type agentConfigLister struct {
	listers.ResourceIndexer[*apiv1alpha1.AgentConfig]
}

// NewAgentConfigLister returns a new AgentConfigLister.
func NewAgentConfigLister(indexer cache.Indexer) AgentConfigLister {
	return &agentConfigLister{listers.New[*apiv1alpha1.AgentConfig](indexer, apiv1alpha1.Resource("agentconfig"))}
}

// AgentConfigs returns an object that can list and get AgentConfigs.
func (s *agentConfigLister) AgentConfigs(namespace string) AgentConfigNamespaceLister {
	return agentConfigNamespaceLister{listers.NewNamespaced[*apiv1alpha1.AgentConfig](s.ResourceIndexer, namespace)}
}
...
type AgentConfigNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1alpha1.AgentConfig, error)
